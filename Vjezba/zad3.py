...
a = [0, -1, -1, -1, -1]       # Donja dijagonala
b = [1, 2, 3, 4, 5]          # Glavna dijagonala
c = [-3, -3, -3, -3, 0]       # Gornja dijagonala
d = [5, 4, 3, 2, 1]          # Slobodni clanovi

n = len(d) # Broj jednadzbi i nepoznanica
faktor = 29 # Faktor za skaliranje struja
...
# Ispis rjesenja
print("Rjesenja struja I1, I2, I3, I4, I5 su:")
for i, val in enumerate(x, start=1):
    print(f"I{i} = {val:.3f} A")

print("29*I_{1,2,3,4,5}:")
for i, val in enumerate(x, start=1):
    scaled = faktor * val
